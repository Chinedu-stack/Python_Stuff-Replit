...
class BookingService:
    ...
    def book(self, appointment):
        if self.check_available(appointment.barber, appointment.time):
            self.system.add_booking(appointment)
            print("Appointment Booked.")
        else:
            print("Can't book. Barber is busy")
...
app2 = Booking(customer1, barber1, "17:00")
service.book(appointment1)
service.change_time(appointment1.booking_id, "1:00")
service.details()
